...
@Component({
  selector: 'app-user-accounts-sidebar',
  templateUrl: './user-accounts-sidebar.component.html',
  styleUrls: ['./user-accounts-sidebar.component.scss']
})
export class UserAccountsSidebarComponent implements OnInit {
