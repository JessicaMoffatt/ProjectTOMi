...
public class DataDumpReportLine {
  ...
  public DataDumpReportLine(LocalDate date, Project project, Entry entry, UserAccount userAccount){
    this.date = date;
    ...
    this.billable = entry.getTask() == null ? false : entry.getTask().isBillable();
